...
let student = {
  name: 'Hussain',
  studyForExam: function () {
    console.log(`Be quiet! ${this.name} is studying!`);
    setTimeout(
      () => console.log(`Almost time for ${this.name} to take the exam!`),
      1000
    );
  },
};
...
//       '...' +
//         this.name +
//         ' is thinking...*why do all my students get A grades?*'
//     );
//   },
// };
...
const teacher = {
  ...
  gradeHomework: function () {
    console.log(
      `... ${this.name} is thinking...*why do all my students get A grades?*`
    );
  },
};
