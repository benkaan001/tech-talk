// Write a function that takes in a string containing at least one word,
//but may contain several.
//It should return the same string, but
// any words containing five (5) or more letters should be reversed.

// Examples:
// wordTumble("Hello this is a fantastic example.") => "olleH this is a citsatnaf elpmaxe"
